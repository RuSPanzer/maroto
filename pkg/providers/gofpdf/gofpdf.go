...
func (g *gofpdfProvider) CalculateImageHeight(value string, prop props.Rect, extension extension.Type) float64 {
	return g.image.CalculateImageHeight(value, prop, extension)
}
